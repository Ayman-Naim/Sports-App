...
class LeagesViewModel {
    ...
    func fetch(completionHandler: @escaping ([Leagues]?) -> Void) {
        ...
        ApiManger.SharedApiManger.fetchLeagues(url: "https://apiv2.allsportsapi.com/\(sport ?? "")/?met=Leagues&APIkey=7dbbe4899351e7c403259b7b2f31e9bf9aaba8a00cb18487724163d013402aaf", decodingModel: LeaguesModel.self) { data, error in
